  ...
  return (
    <div className="min-h-full bg-gray-100 dark:bg-[#121212] transition-colors">
      <div className="p-6 max-w-4xl mx-auto">
        ...
        {/* Formulário */}
        <form onSubmit={handleSubmit} className="bg-white/95 dark:bg-[#1e1e1e]/95 border border-gray-200 dark:border-[#2d2d2d] rounded-xl shadow-md p-6 transition-colors">
          {/* Mensagem de erro */}
          {error && (
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg bg-white dark:bg-[#2a2a2a]
          ...
          {/* Grid para Categoria e Prioridade */}
          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            ...
            <ul className="text-xs text-blue-800 dark:text-blue-400 space-y-1">
              <li>
                <strong>Baixa:</strong> Problemas menores que não afetam o trabalho
              </li>
              <li>
                <strong>Média:</strong> Problemas que causam inconveniência mas há alternativas
              </li>
              <li>
                <strong>Alta:</strong> Problemas que impedem trabalho importante
              </li>
              <li>
                <strong>Crítica:</strong> Sistema parado ou perda de dados iminente
              </li>
            </ul>
          </div>
